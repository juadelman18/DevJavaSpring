...
public class Partido {
	...
	/*	String loca=elocal.getNombre();
		...
		/*
		return "Partido [Local=" + elocal.toString() + "\n"  + ", Vistante=" + evistante.toString() + "\n"  + ", arbitro Principal=" + arbitro1.toString() + "\n"  + ", arbitro Linea=" + arbitro2.toString() + "\n"  +", estadioLocal="
				+ estadioLocal.toString() + "\n"  + ", fecha=" + fecha + "\n"  + ", marcadorLocal=" + marcadorLocal + "\n"  + ", marcadorVisitante="
				+ marcadorVisitante + "]";
		*/
		return "Partido [Local=" + elocal.toString() + "\n" +  ", Vistante=" + evistante.toString() + "\n"  +  ", arbitro Principal=" + arbitro1.toString() + "\n"  +  ", estadioLocal="
		+ estadioLocal.toString() + "\n"  + ", fecha=" + fecha + "\n"  + ", marcadorLocal=" + marcadorLocal + "\n"  + ", marcadorVisitante="
